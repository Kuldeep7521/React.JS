        ...
        <div className="">
            ...
            >
                <div className="grid place-content-center py-52 bg-no-repeat">
                    ...
                    <h1 className="text-6xl text-white bg-no-repeat pr-96">
                        HIGHLY STRENGTH
                        <br /> AND LONG LASTING
                    </h1>
                </div>
            ...
            <div className="grid grid-cols-2 max-[974px]:flex flex-col justify-center items-center">
                <div className=" ">
                    <div className="relative top-[10px] left-20 max-lg:left-10 ">
                        <img
                            className="  h-[552px] w-fit max-xl:w-[428px] max-xl:h-[428px]  "
                            src="./Images/G127.png"
                            alt=""
                        />
                    </div>

                    <div className="absolute top-[1000px] left-56 max-xl:top-[850px] max-xl:left-40 max-lg:left-32  ">
                        <span className="text-[320px]  text-cyan-600  ">10</span>
            ...
            <div className="bg-regal-blue bg-no-repeat grid grid-cols-2 " >
                ...
                <div className="bg-no-repeat" style={{ backgroundImage: "url(/Images/image22.png)" }}>
                    <div className="flex gap-3 relative -bottom-72">
            ...
            <div>
                ...
                <br />
                <br />
                <div className="grid grid-cols-4  px-24 max-xl:px-10 gap-5 max-lg:grid-cols-2">
            ...
            <div className="bg-regal-blue">
                ...
                <div className="grid grid-cols-3 gap-3 text-center px-20">
                ...
                <div className="bg-white pt-60">
                    <div className="">
                        <div className="grid grid-cols-2 bg-regal-blue mx-20">
                            <div className="flex justify-center p-10">
                                <img className="relative left-24" src="./Images/G141.png" alt="" />
                                <img className="h-[180px] relative right-60 top-20 max-xl:right-2/4 max-lg:right-2/4 max-lg:h-[142px]" src="./Images/img.png" alt="" />

                            </div>
                            <div className="flex justify-center flex-col">
                                <p className="text-[40px]">TESTIMONIAL</p>
            ...
            <div>
                ...
                <div className="grid grid-cols-4 px-20 gap-20 max-lg:grid-cols-2">
                <div className="">
