...
const Navbar = () => {
    return (
        <div>
            ...
            <div className=" max-sm:text-black max-sm:text-right p-4 justify-between flex items-center max-md:flex-col gap-10">
                ...
                <button className='border border-black w-fit mr-14 p-2 rounded-md text-[16px]'>Contact</button>
            </div>
