...
// import img2 from "../images/Shop/2.png";
// import img3 from "../images/Shop/3.png";
// import img4 from "../images/Shop/4.jpeg";
// import img5 from "../images/Shop/5.jpeg";
// import img6 from "../images/Shop/6.jpeg";
...
const Shop = () => {
  ...
  return (
    <div>
      <div
        style={{ backgroundImage: 'url("./Shop/banner-2.png")' }}
        className="bg-cover "
      >
      ...
      <div className="grid grid-cols-4 m-2 gap-10 max-lg:grid-cols-2 gap-2 max-md:grid-cols-1 gap-2">
        ...
        <div className="grid grid-cols-4 gap-5 col-span-3 text-center max-xl:grid-cols-3 max-lg:grid-cols-3 max-md:grid-cols-2  max-sm:grid-cols-1">
          ...
          {/* <div className="col-span-1 group  z-10">
            <div className="relative overflow-hidden">
              <img src={img} alt="" />
              <button className="bg-black text-white w-full p-2 -z-0  group-hover:block absolute -bottom-10 group-hover:bottom-0 transition-all duration-300 ease-out">
                Add to Cart
              </button>
            </div>
            <p>product name</p>
